    ...
    <>
      ...
      <Paper sx={{ position: 'fixed', bottom: 0, left: 0, right: 0 }}>
        <BottomNavigation showLabels >
          ...
          <BottomNavigationAction sx={{ backgroundColor: page !== totalPages && books.length === 20 ? '#FF0000' : '', color: page !== totalPages ? 'white' : 'lightgray' }} disabled={page === totalPages || books.length !== 20} onClick={() => setPage(prevPage => prevPage + 1)} label="Next" icon={<NavigateNextIcon />} />
        </BottomNavigation>
      </Paper>
    </>
  );
